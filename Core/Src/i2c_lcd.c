...
static uint8_t LCD_I2C_SLAVE_ADDRESS=LCD_I2C_SLAVE_ADDRESS_0;


/* Private functions */
static void lcd16x2_i2c_write4bit(uint8_t command)
{
  uint8_t i2cData[2] =
  {
      command | LCD_EN | LCD_BK_LIGHT,
      command | LCD_BK_LIGHT,
  };
  HAL_I2C_Master_Transmit(lcd16x2_i2cHandle, LCD_I2C_SLAVE_ADDRESS, (uint8_t*) i2cData, sizeof(i2cData), 100);
//  HAL_Delay(1);
}
...
bool lcd16x2_i2c_init(I2C_HandleTypeDef *pI2cHandle)
{
  ...
  lcd16x2_i2c_write4bit(0x30);
  HAL_Delay(5);
  lcd16x2_i2c_write4bit(0x30);
  HAL_Delay(1);
  lcd16x2_i2c_write4bit(0x30);
  HAL_Delay(1);
  lcd16x2_i2c_write4bit(0x20);
  HAL_Delay(1);
